...
public class InventoryService {
	...
	public ArrayList <Transaction> findByKeyword(String keyword){
		...
		for (int i = 0; i < inventory.size(); i++) {
			if (inventory.get(i).getDetails().toUpperCase().contains(keyword.toUpperCase())) {
	...
	public void populateApp() {
		if (isPopulated == false) {
			Transaction transaction1 = new Transaction(1, LocalDate.of(2021, 5, 11), "Used", 2015, "Black", "Honda", "Accord", 15499, "Great condition", 71200);
			inventory.add(transaction1);
			
			Transaction transaction2 = new Transaction(2, LocalDate.of(2021, 7, 12), "Used", 2018, "Blue", "Hyuandai", "Sonata", 16799, "Great condition", 38578);
			inventory.add(transaction2);
			
			Transaction transaction3 = new Transaction(3, LocalDate.of(2021, 10, 1), "Used", 2020, "Black", "Toyota", "Tundra", 42499, "Great condition", 7988);
			inventory.add(transaction3);
			
			Transaction transaction4 = new Transaction(4, LocalDate.of(2020, 10, 8), "Used", 2019, "White", "Ford", "Fiesta", 11299, "Great condition", 16542);
			inventory.add(transaction4);
			
			Transaction transaction5 = new Transaction(5, LocalDate.of(2020, 10, 31), "Used", 2014, "Gray", "Nissan", "Maxima", 9999, "Great condition", 92002);
			inventory.add(transaction5);
			
			Transaction transaction6 = new Transaction(6, LocalDate.of(2021, 10, 8), "New", 2020, "Silver", "Ford", "Explorer", 36000, "Great condition", 807);
			inventory.add(transaction6);
			
			Transaction transaction7 = new Transaction(7, LocalDate.of(2021, 9, 27), "New", 2020, "Red", "Toyota", "Corolla", 23500, "Great condition", 602);
			inventory.add(transaction7);
			
			Transaction transaction8 = new Transaction(8, LocalDate.of(2021, 10, 5), "New", 2021, "Black", "Audi", "A3", 44999, "Great condition", 701);
			inventory.add(transaction8);
			
			Transaction transaction9 = new Transaction(9, LocalDate.of(2021, 5, 3), "New", 2021, "Blue", "Ford", "Mustang", 31000, "Great condition", 211);
			inventory.add(transaction9);
			
			Transaction transaction10 = new Transaction(10, LocalDate.of(2021, 8, 22), "New", 2020, "Green", "Chevrolet", "Suburban", 37000, "Great condition", 345);
